...
[cas_cl1, speedUpdated] = AC.ARPM.climbSpeed(
    h=conv.ft2m(Hp_RWY), mass=m_init, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)  # [m/s] take-off CAS
...
[cas_cl2, speedUpdated] = AC.ARPM.climbSpeed(
    h=conv.ft2m(2999), mass=m_final, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)
...
[cas_cl3, speedUpdated] = AC.ARPM.climbSpeed(
    h=conv.ft2m(3999), mass=m_final, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)
...
[cas_cl4, speedUpdated] = AC.ARPM.climbSpeed(
    h=conv.ft2m(4999), mass=m_final, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)
...
[cas_cl5, speedUpdated] = AC.ARPM.climbSpeed(
    h=conv.ft2m(5999), mass=m_final, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)
...
[cas_cl6, speedUpdated] = AC.ARPM.climbSpeed(
    h=conv.ft2m(9999), mass=m_final, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)
...
[cas, speedUpdated] = AC.ARPM.descentSpeed(
    h=conv.ft2m(1999), mass=m_final, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)
...
[cas, speedUpdated] = AC.ARPM.descentSpeed(
    h=conv.ft2m(1499), mass=m_final, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)
...
[cas, speedUpdated] = AC.ARPM.descentSpeed(
    h=conv.ft2m(999), mass=m_final, theta=theta, delta=delta, DeltaTemp=DeltaTemp
)
